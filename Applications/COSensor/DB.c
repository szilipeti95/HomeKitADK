...
#define kIID_COSensor                 ((uint64_t) 0x0030)
 ...
 */
static const HAPDataCharacteristic coSensorServiceSignatureCharacteristic = {
    .format = kHAPCharacteristicFormat_Data,
    .iid = kIID_COSensorServiceSignature,
    .characteristicType = &kHAPCharacteristicType_ServiceSignature,
    .debugDescription = kHAPCharacteristicDebugDescription_ServiceSignature,
    .manufacturerDescription = NULL,
    .properties = { .readable = true,
 ...
 */
static const HAPStringCharacteristic coSensorNameCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_COSensorName,
    .characteristicType = &kHAPCharacteristicType_Name,
    .debugDescription = kHAPCharacteristicDebugDescription_Name,
    .manufacturerDescription = NULL,
    .properties = { .readable = true,
 ...
 */
const HAPService coSensorService = {
    .iid = kIID_COSensor,
